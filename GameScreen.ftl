...
<div class="w3-display-container w3-center" id="card" style="display: none; z-index: -1">
    <img src="http://www.spelplus.com/postpic/2009/04/trading-card-game-template_314360.jpg" >


<div class= "ship w3-display-topmiddle w3-container w3-text-white w3-padding-32 w3-hide-medium" style="display: none" >
    <img src="http://www.dcs.gla.ac.uk/~richardm/TopTrumps/Constellation.jpg" style="width:100%; height: 100%"> 
        <div class=" w3-left">
            <h2>Round 1 - Top Card of your Deck </h2>
                <ul class="specs">
                        <li>Size    </li>
                        <li>Speed </li>
                        <li>Range </li>
...
<div class="w3-display-middle w3-container w3-text-white w3-padding-32 w3-hide-small" style="display: none" id="panel">
    ...
    <button class="button gamebutton select">1</button>
    <button class="button gamebutton select">2</button>
    <button class="button gamebutton select">3</button>
    <button class="button gamebutton select">4</button>
